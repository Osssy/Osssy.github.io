...
ANCORA_GLOBALS['ajax_nonce'] = '41daa45081';
ANCORA_GLOBALS['ajax_nonce_editor'] = 'f2d08e599d';
ANCORA_GLOBALS['site_url'] = 'http://optima-html.ancorathemes.com';
ANCORA_GLOBALS['vc_edit_mode'] = false;
ANCORA_GLOBALS['theme_font'] = '';
ANCORA_GLOBALS['theme_skin'] = 'optima';
ANCORA_GLOBALS['theme_skin_bg'] = '';
ANCORA_GLOBALS['slider_height'] = 1000;
ANCORA_GLOBALS['system_message'] = {message: '', status: '', header: ''};
ANCORA_GLOBALS['user_logged_in'] = false;
ANCORA_GLOBALS['toc_menu'] = 'fixed';
ANCORA_GLOBALS['toc_menu_home'] = true;
ANCORA_GLOBALS['toc_menu_top'] = true;
ANCORA_GLOBALS['menu_fixed'] = true;
ANCORA_GLOBALS['menu_relayout'] = 960;
ANCORA_GLOBALS['menu_responsive'] = 800;
ANCORA_GLOBALS['menu_slider'] = true;
...
ANCORA_GLOBALS['menu_animation_in'] = 'none';
ANCORA_GLOBALS['menu_animation_out'] = 'fadeOutDown';
...
ANCORA_GLOBALS['link_color'] = '';
ANCORA_GLOBALS['menu_color'] = '';
ANCORA_GLOBALS['user_color'] = '';
var wc_single_product_params = {"i18n_required_rating_text":"Please select a rating","review_rating_required":"yes"};

jQuery(document).ready(function() {
	"use strict";
	ANCORA_GLOBALS['theme_init_counter'] = 0;
    ancora_init_messages();
	ancora_init_actions();
