                        ...
                        <div className="col-lg-12">
                            ...
                            <div className="row">
                                ...
                                <div className="footer-widget mb-0">
                                    ...
                                    <p className="address">111111, г.Москва, ул.Малиновая, д.10, к.1, э.1, пом.1, к.1, оф.11</p>
                                    <ul className="contact-details">
                                        <li><span>Телефон:</span>+1(111)111-11-11</li>
                                        <li><span>Электронная почта:</span>merkon@mail.ru</li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
