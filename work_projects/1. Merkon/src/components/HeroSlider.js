...
class HeroSlider extends Component{
    render(){
        ...
        let data = [
            {bgImg: 'slider3.jpg', sliderTitle: 'ООО Меркон', sliderSubtitle: 'Лесоматериалы', btnLink: 'contact-us'},
            {bgImg: 'slider2.jpg', sliderTitle: 'ООО Меркон', sliderSubtitle: 'Строительные материалы', btnLink: 'contact-us'},
            {bgImg: 'slider1.jpg', sliderTitle: 'ООО Меркон', sliderSubtitle: 'Санитарно-техническое оборудование', btnLink: 'contact-us'}
        ];
                        ...
                        <div className="hero-slider__content-wrapper">
                            ...
                            <div className="row">
                                ...
                                <div className="hero-slider__content m-auto text-center">
                                    ...
                                    <a className="hero-slider__btn hero-slider__btn--style2" href={`${process.env.PUBLIC_URL}/${val.btnLink}`}>НАЧАТЬ СОТРУДНИЧЕСТВО</a>
                                </div>
                                </div>
                            </div>
                            </div>
