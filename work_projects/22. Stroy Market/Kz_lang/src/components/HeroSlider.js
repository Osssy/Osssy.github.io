...
class HeroSlider extends Component{
    render(){
        ...
        let data = [
            {bgImg: 'slider5.jpg', sliderTitle: 'Ағаш', sliderSubtitle: '«Строй Маркет Компани» ЖШС', btnLink: 'productions'},
            {bgImg: 'slider2.jpg', sliderTitle: 'Құрылыс материалдары', sliderSubtitle: '«Строй Маркет Компани» ЖШС', btnLink: 'productions'},
            {bgImg: 'slider4.jpg', sliderTitle: 'Санитарлық жабдықтар', sliderSubtitle: '«Строй Маркет Компани» ЖШС', btnLink: 'productions'}
        ];
                        ...
                        <div className="hero-slider__content-wrapper">
                            ...
                            <div className="row">
                                ...
                                <div className="hero-slider__content">
                                    ...
                                    <a className="hero-slider__btn" href={`${process.env.PUBLIC_URL}/${val.btnLink}`}>КӨП ҮЙРЕНЕДІ</a>
                                </div>
                                </div>
                            </div>
                            </div>
