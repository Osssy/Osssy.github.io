...
class HeroSlider extends Component{
    render(){
        ...
        let data = [
            {bgImg: 'slider5.jpg', sliderTitle: 'Лесоматериалы', sliderSubtitle: 'ТОО «Строй Маркет Компани»', btnLink: 'productions'},
            {bgImg: 'slider2.jpg', sliderTitle: 'Строительные материалы', sliderSubtitle: 'ТОО «Строй Маркет Компани»', btnLink: 'productions'},
            {bgImg: 'slider4.jpg', sliderTitle: 'Санитарно-техническое оборудование', sliderSubtitle: 'ТОО «Строй Маркет Компани»', btnLink: 'productions'}
        ];
                        ...
                        <div className="hero-slider__content-wrapper">
                            ...
                            <div className="row">
                                ...
                                <div className="hero-slider__content">
                                    ...
                                    <a className="hero-slider__btn" href={`${process.env.PUBLIC_URL}/${val.btnLink}`}>ПОДРОБНЕЕ</a>
                                </div>
                                </div>
                            </div>
                            </div>
