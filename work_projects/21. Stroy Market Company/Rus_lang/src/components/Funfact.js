...
class Funfact extends Component{
    ...
    render(){
        ...
        let data = [
            {img: 'funfact-project.png', countNum : 107, countTitle: 'Заказов' },
            {img: 'funfact-clients.png', countNum : 32, countTitle: 'Постоянных клиента' },
            {img: 'funfact-success.png', countNum : 26, countTitle: 'Быстро выполненных сделок' },
            {img: 'funfact-award.png', countNum : 9, countTitle: 'Различных бонусов' }
        ];
