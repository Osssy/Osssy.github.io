                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="header-info-wrapper align-items-center">
                                    ...
                                    <div className="header-info-single-item">
                                        ...
                                        <p className="header-info-single-item__subtitle"><a href={`${process.env.PUBLIC_URL}/contact-us#map`}>111111, Казахстан, г. Алматы, <br></br>проспект Космонавтов 11, офис 111</a></p>
                                        </div>
                                    </div>
                                    </div>
                                    {/* mobile menu */}
