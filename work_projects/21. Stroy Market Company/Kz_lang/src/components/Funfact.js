...
class Funfact extends Component{
    ...
    render(){
        ...
        let data = [
            {img: 'funfact-project.png', countNum : 107, countTitle: 'Тапсырыстар' },
            {img: 'funfact-clients.png', countNum : 32, countTitle: 'Тұрақты клиенттер' },
            {img: 'funfact-success.png', countNum : 26, countTitle: 'Тез аяқталған мәмілелер' },
            {img: 'funfact-award.png', countNum : 9, countTitle: 'Әр түрлі бонустар' }
        ];
