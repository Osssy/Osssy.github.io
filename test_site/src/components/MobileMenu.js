                    ...
                    <div className="offcanvas-wrapper">
                        ...
                        <div className="offcanvas-widget-area">
                            ...
                            <div className="header-contact-info">
                                ...
                                <li><i className="ion-android-phone-portrait" /> <a href="tel://+7(985)624-28-52">+7(985)624-28-52</a></li>
                                <li><i className="ion-android-mail" /> <a href="mailto:merkon-77@mail.ru">merkon-77@mail.ru</a></li>
                                </ul>
                            </div>
                            </div>
                        </div>
